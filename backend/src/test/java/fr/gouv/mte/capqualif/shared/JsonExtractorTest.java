...
public class JsonExtractorTest {
    ...
    public void findItemFirstLevelMatchingJson() {
        ...
        List<JsonObject> testedList = jsonExtractor.findMatchingJsonObjects(initialJson, "idIteTitreDetenu", "839308");
    ...
    public void findItemSecondLevelMatchingJson() {
        ...
        JsonExtractor jsonExtractor = new JsonExtractor();
        List<JsonObject> testedList = jsonExtractor.findMatchingJsonObjects(initialJson, "libelle",
    ...
    public void findAmforeFirstLevelMatchingJson() {
        ...
        JsonExtractor jsonExtractor = new JsonExtractor();
        List<JsonObject> testedList = jsonExtractor.findMatchingJsonObjects(initialJson, "libelleModuleUv", "P3–Appui"
