...
class RulesControllerTest {
    ...
    @Test
    void shouldReturnTrueWhenAllIsTrue() throws IOException {
        // Given
//        String json = "{\n" +
//                "  \"titre\": \"Matelot Pont\",\n" +
//                "  \"operations\": [\n" +
...
//                "}";
    ...
    @Test
    private void shouldReturnTrueWhenFormationsAreOkButNotReconnus() {

    }

    private Operations jsonToOperations(String location) throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        Operations operations = objectMapper.readValue(new File(location), Operations.class);
