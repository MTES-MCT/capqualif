package fr.gouv.mte.capqualif.domain.capQualif.instruction.application.services;

import fr.gouv.mte.capqualif.domain.capQualif.instruction.domain.ComparisonResult;
import fr.gouv.mte.capqualif.domain.capQualif.instruction.application.ports.in.CompareMarinDataToConditionsTitreUseCase;
import fr.gouv.mte.capqualif.domain.capQualif.instruction.application.ports.out.GetMarinDataPort;
...
import fr.gouv.mte.capqualif.domain.capAdmin.mock.EntryInExistingDataSource;
import fr.gouv.mte.capqualif.domain.capAdmin.mock.ExistingDataSource;
import fr.gouv.mte.capqualif.domain.capAdmin.mock.KeyInExistingDataSource;
